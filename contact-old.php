    ...
    <?php endif; ?>
          ...
          <form action="" method="POST">
            <div class="row g-4">
              ...
              <div class="col-lg-6">
                <div class="form-floating">
                  <input type="tel" class="form-control border-0 shadow-sm" id="phone" name="phone" placeholder="Your Phone">
                  <label for="phone">Your Phone</label>
                </div>
              </div>
              <div class="col-lg-6">
                <div class="form-floating">
                  <input type="text" class="form-control border-0 shadow-sm" id="project" name="project" placeholder="Your Project">
                  <label for="project">Project</label>
                </div>
              </div>
              <div class="col-12">
                <div class="form-floating">
                  <input type="text" class="form-control border-0 shadow-sm" id="subject" name="subject" placeholder="Subject">
                  <label for="subject">Subject</label>
                </div>
              </div>
              <div class="col-12">
                <div class="form-floating">
                  <textarea class="form-control border-0 shadow-sm" placeholder="Leave a message here" id="message" name="message" style="height: 125px" required></textarea>
              ...
              <div class="col-12">
                <button class="btn btn-info w-100 py-3 fw-bold shadow-sm" type="submit">Send Message</button>
              </div>
            </div>
          </form>
        </div>
